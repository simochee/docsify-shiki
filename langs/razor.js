    ...
    "repository": {
      ...
      "anonymous-method-expression": {
        "patterns": [
          ...
          {
            "begin": "((?:\\b(?:async|static)\\b\\s*)*)\\b(delegate)\\b\\s*",
            "beginCaptures": {
              "1": {
                "patterns": [
                  {
        ...
        "patterns": [
          {
            ...
            "match": "(?<type-name>(?:(?:(?:(?<identifier>@?[_[:alpha:]][_[:alnum:]]*)\\s*\\:\\:\\s*)?(?<name-and-type-args>\\g<identifier>\\s*(?<type-args>\\s*<(?:[^<>]|\\g<type-args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name-and-type-args>)*|(?<tuple>\\s*\\((?:[^\\(\\)]|\\g<tuple>)+\\)))(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))\\s*(?:(\\g<identifier>)\\b)?"
          }
        ]
      },
      "code-directive": {
        ...
        "patterns": [
          {
            ...
            "match": "(?:(\\bvar\\b)|(?<type-name>(?:(?:(?:(?<identifier>@?[_[:alpha:]][_[:alnum:]]*)\\s*\\:\\:\\s*)?(?<name-and-type-args>\\g<identifier>\\s*(?<type-args>\\s*<(?:[^<>]|\\g<type-args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name-and-type-args>)*|(?<tuple>\\s*\\((?:[^\\(\\)]|\\g<tuple>)+\\)))(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*)))\\s+(\\g<identifier>)\\s+\\b(in)\\b"
          },
          {
            "captures": {
              "1": {
