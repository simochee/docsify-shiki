...
$docsify.shiki.langs.push([
  {
    ...
    "repository": {
      ...
      "data-type": {
        "patterns": [
          ...
          },
          {
            ...
            "match": "(\\()\\s*(?:(string-ascii|string-utf8)\\s+(\\d+))\\s*(\\))"
          },
          {
            "captures": {
              "1": {
      ...
      "define-constant": {
        "begin": "(\\()\\s*(define-constant)\\s+([a-zA-Z][\\w\\?\\!\\-]*)\\s+",
        "beginCaptures": {
          "1": {
      ...
      "define-data-var": {
        "begin": "(\\()\\s*(define-data-var)\\s+([a-zA-Z][\\w\\?\\!\\-]*)\\s+",
        "beginCaptures": {
          "1": {
      ...
      "define-function": {
        "begin": "(\\()\\s*(define-(?:public|private|read-only))\\s+",
        "beginCaptures": {
          "1": {
      ...
      "define-fungible-token": {
        ...
        "match": "(\\()\\s*(define-fungible-token)\\s+([a-zA-Z][\\w\\?\\!\\-]*)(?:\\s+(u\\d+))?"
      },
      "define-map": {
        "begin": "(\\()\\s*(define-map)\\s+([a-zA-Z][\\w\\?\\!\\-]*)\\s+",
        "beginCaptures": {
          "1": {
      ...
      "define-non-fungible-token": {
        "begin": "(\\()\\s*(define-non-fungible-token)\\s+([a-zA-Z][\\w\\?\\!\\-]*)\\s+",
        "beginCaptures": {
          "1": {
      ...
      "define-trait": {
        "begin": "(\\()\\s*(define-trait)\\s+([a-zA-Z][\\w\\?\\!\\-]*)\\s+",
        "beginCaptures": {
          "1": {
      ...
      "get-set-func": {
        "begin": "(\\()\\s*(var-get|var-set|map-get\\?|map-set|map-insert|map-delete|get)\\s+([a-zA-Z][\\w\\?\\!\\-]*)\\s*",
        "beginCaptures": {
          "1": {
      ...
      "literal": {
        ...
        "repository": {
          ...
          "principal-literal": {
            "match": "\\'[0-9A-Z]{28,41}(:?\\.[a-zA-Z][a-zA-Z0-9\\-]+){0,2}|(\\.[a-zA-Z][a-zA-Z0-9\\-]*){1,2}(?=[\\s(){},]|$)",
      ...
      "use-trait": {
        "begin": "(\\()\\s*(use-trait)\\s+([a-zA-Z][\\w\\?\\!\\-]*)\\s+",
        "beginCaptures": {
          "1": {
