    ...
    "repository": {
      ...
      "primatives": {
        "patterns": [
          ...
          {
            "match": "\\G[0-9]{4}-(0[1-9]|1[012])-(?!00|3[2-9])[0-3][0-9]([Tt ](?!2[5-9])[0-2][0-9]:[0-5][0-9]:(?!6[1-9])[0-6][0-9](\\.[0-9]+)?(Z|[+-](?!2[5-9])[0-2][0-9]:[0-5][0-9])?)?",
            "name": "constant.other.date.toml"
          },
          {
            "match": "\\G(?!2[5-9])[0-2][0-9]:[0-5][0-9]:(?!6[1-9])[0-6][0-9](\\.[0-9]+)?",
