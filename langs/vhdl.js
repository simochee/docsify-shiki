...
$docsify.shiki.langs.push([
  {
    ...
    "repository": {
        ...
        "patterns": [
          {
            ...
            "end": "\\b((?i:end))(\\s+((?i:architecture)))?(\\s+((\\3)|(.+?)))?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
        ...
        "patterns": [
          {
            ...
            "end": "\\b((?i:end))\\s+(((?i:component\\b))|(.+?))(?=\\s*|;)(\\s+((\\3)|(.+?)))?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
      ...
      "entity_pattern": {
        "patterns": [
          {
            "begin": "^\\s*((?i:entity\\b))\\s+(([a-zA-Z][a-zA-Z\\d_]*)|(.+?))(?=\\s)",
            "beginCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
            ...
            "end": "\\b((?i:end\\b))(\\s+((?i:entity)))?(\\s+((\\3)|(.+?)))?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
        ...
        "patterns": [
          {
            ...
            "end": "\\b((?i:end))\\s+(((?i:generate|loop))|(\\S+))\\b(\\s+((\\2)|(.+?)))?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
      ...
      "function_definition_pattern": {
        "patterns": [
          {
            "begin": "^\\s*((?i:impure)?\\s*(?i:function))\\s+(([a-zA-Z][a-zA-Z\\d_]*)|(\"\\S+\")|(\\\\.+\\\\)|(.+?))(?=\\s*(\\(|(?i:\\breturn\\b)))",
            "beginCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
            ...
            "end": "^\\s*((?i:end))(\\s+((?i:function)))?(\\s+((\\3|\\4|\\5)|(.+?)))?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
        ...
        "patterns": [
          {
            ...
            "end": "\\b((?i:end))\\s+((((?i:generate|if))|(\\S+))\\b(\\s+((\\2)|(.+?)))?)?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
      ...
      "package_body_pattern": {
        "patterns": [
          {
            "begin": "\\b((?i:package))\\s+((?i:body))\\s+(([a-zA-Z][a-zA-Z\\d_]*)|(.+?))\\s+((?i:is))\\b",
            "beginCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
            ...
            "end": "\\b((?i:end\\b))(\\s+((?i:package))\\s+((?i:body)))?(\\s+((\\4)|(.+?)))?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
      ...
      "package_pattern": {
        "patterns": [
          {
            "begin": "\\b((?i:package))\\s+(?!(?i:body))(([a-zA-Z][a-zA-Z\\d_]*)|(.+?))\\s+((?i:is))\\b",
            "beginCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
            ...
            "end": "\\b((?i:end\\b))(\\s+((?i:package)))?(\\s+((\\2)|(.+?)))?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
      ...
      "procedure_definition_pattern": {
        "patterns": [
          {
            "begin": "^\\s*((?i:procedure))\\s+(([a-zA-Z][a-zA-Z\\d_]*)|(\"\\S+\")|(.+?))(?=\\s*(\\(|(?i:is)))",
            "beginCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
            ...
            "end": "^\\s*((?i:end))(\\s+((?i:procedure)))?(\\s+((\\3|\\4)|(.+?)))?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
        ...
        "patterns": [
          {
            ...
            "end": "((?i:end))(\\s+((?:postponed\\s+)?(?i:process)))(\\s+((\\2)|(.+?)))?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
      ...
      "protected_body_pattern": {
        "patterns": [
          {
            "begin": "\\b((?i:type))\\s+(([a-zA-Z][a-zA-Z\\d_]*)|(.+?))\\s+\\b((?i:is\\s+protected\\s+body))\\s+",
            "beginCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
            ...
            "end": "\\b((?i:end\\s+protected\\s+body))(\\s+((\\3)|(.+?)))?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
      ...
      "protected_pattern": {
        "patterns": [
          {
            "begin": "\\b((?i:type))\\s+(([a-zA-Z][a-zA-Z\\d_]*)|(.+?))\\s+\\b((?i:is\\s+protected))\\s+(?!(?i:body))",
            "beginCaptures": {
              "1": {
            ...
            "end": "\\b((?i:end\\s+protected))(\\s+((\\3)|(.+?)))?(?!(?i:body))(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
        ...
        "patterns": [
          {
            ...
            "end": "\\b((?i:end))\\s+((?i:record))(\\s+(([a-zA-Z][a-zA-Z\\d_]*)|(.*?)))?(?=\\s*;)",
            "endCaptures": {
              "1": {
                "name": "keyword.language.vhdl"
              },
