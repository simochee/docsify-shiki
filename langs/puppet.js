...
$docsify.shiki.langs.push([
  {
    ...
    "patterns": [
      ...
      {
        "begin": "\\b(class)\\s+((?:[a-z][a-z0-9_]*)?(?:::[a-z][a-z0-9_]*)+|[a-z][a-z0-9_]*)\\s*",
        "captures": {
          "1": {
            "name": "storage.type.puppet"
          },
      ...
      {
        "begin": "^\\s*(plan)\\s+((?:[a-z][a-z0-9_]*)?(?:::[a-z][a-z0-9_]*)+|[a-z][a-z0-9_]*)\\s*",
        "captures": {
          "1": {
            "name": "storage.type.puppet"
          },
      ...
      {
        "begin": "^\\s*(define|function)\\s+([a-z][a-z0-9_]*|(?:[a-z][a-z0-9_]*)?(?:::[a-z][a-z0-9_]*)+)\\s*(\\()",
        "captures": {
          "1": {
    ...
    "repository": {
      ...
      "resource-definition": {
        "begin": "(?:^|\\b)(::[a-z][a-z0-9_]*|[a-z][a-z0-9_]*|(?:[a-z][a-z0-9_]*)?(?:::[a-z][a-z0-9_]*)+)\\s*({)\\s*",
        "beginCaptures": {
          "1": {
